...
let RegisterComponent = class RegisterComponent {
    constructor(fb, iconRegistry, sanitizer) {
        this.fb = fb;
        iconRegistry.addSvgIcon('close', sanitizer.bypassSecurityTrustResourceUrl('assets/imgs/close.svg'));
    }
    get email() { return this.registerForm.get('email'); }
    get plantationName() { return this.registerForm.get('plantationName'); }
    get companyName() { return this.registerForm.get('companyName'); }
    get contactName() { return this.registerForm.get('contactName'); }
    get contactPhone() { return this.registerForm.get('contactPhone'); }
    get agree() { return this.registerForm.get('agreeWithTermsAndConditions'); }
    ngOnInit() {
        this.registerForm = this.fb.group({
            isPlantation: [false],
            isLegalEntity: [true],
            plantationName: ['', [Object(_utils_formValidators__WEBPACK_IMPORTED_MODULE_3__["conditionalValidator"])(() => this.registerForm.get('isPlantation').value, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required)]],
            companyName: ['', [Object(_utils_formValidators__WEBPACK_IMPORTED_MODULE_3__["conditionalValidator"])(() => ((!this.registerForm.get('isPlantation').value) && (this.registerForm.get('isLegalEntity').value === true)), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required)]],
...
let RestoreComponent = class RestoreComponent {
    ...
    get email() { return this.restoreForm.get('email'); }
    ngOnInit() {
