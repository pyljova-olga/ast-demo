...
@Component({
  selector: '[trade-table-thead]',
  templateUrl: './trade-table-thead.component.pug',
  styleUrls: ['./trade-table-thead.component.scss']
})
export class TradeTableTheadComponent implements OnInit {
  selectedLength = 30;
  sortSettings = {
    id: '',
